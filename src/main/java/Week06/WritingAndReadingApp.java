...
public class WritingAndReadingApp {
    public static void main(String[] args) throws IOException {
        ...
        for (String item : todo) {
            ...
            listNumber++;
            // increase counter. Could also do this in a regular for loop and use the loop counter
        }
        ...
        while (line != null) { // was the last line read equal to null?
            ...
            // Add the last line read to the ArrayList
